#
#  Be sure to run `pod spec lint WEDScratchCardView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  					模拟实现刮奖的过程，只是对刮奖视觉做实现，并未对进一步的细节做实现(例如刮开到什么程度算是刮奖成功，触发结果回调等)
                   DESC

  s.homepage     = "https://github.com/Chasingdreamboy"
  s.screenshots  = "demo.gif"
  ...
  s.source       = { :git => "https://github.com/Chasingdreamboy/WEDScratchCardView.git", :tag => "#{s.version}" }
